...
class Settings(BaseSettings):
    ...
    # PARAM UART settings
    param_timeout: float = Field(default=2.0, description="PARAM request timeout in seconds")

    # Telemetry history
    history_size: int = Field(default=1000, description="Max telemetry packets to keep in history")
