...
struct ForwarderConfig {
    bool forward_attitude = true;       ///< Forward ATTITUDE packets
    bool forward_motors = true;         ///< Forward MOTORS packets
    bool forward_status = true;         ///< Forward STATUS packets
    bool forward_control = false;       ///< Forward CONTROL packets (optional)
    bool forward_sensors = false;       ///< Forward SENSORS packets (optional)
    bool forward_safety = false;        ///< Forward SAFETY packets (optional)
    bool forward_performance = false;   ///< Forward PERFORMANCE packets (optional)
};
